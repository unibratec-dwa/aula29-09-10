...
APP.ajaxCall = function(escopo) {
	var delegate, carregando, carregou, naoCarregou;

		delegate 	= APP.delegate;

		carregando	= delegate(escopo, escopo.carregando);
		carregou 	= delegate(escopo, escopo.carregou);
		naoCarregou = delegate(escopo, escopo.naoCarregou);
